""" Contains a Worst-Fit-Like maintenance algorithm."""
    ...
    # Migrating services to drain outdated edge servers
        ...
        for server in servers_to_empty:
            ...
            for _ in range(len(server.services)):
                ...
                # Migrating services using the Worst-Fit Decreasing heuristic, which
                # prioritizes migrating services to servers with more space remaining
